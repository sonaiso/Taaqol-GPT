...
_DAL_A7_1_RUNTIME_LABEL = "DAL-A7.1 Harden DAL-A7 LAFZI/LAFZI-B handoff deferral semantics"
...
def test_pv_t0_1_chain_status_records_close_4_and_close_5_done_and_dal_a7_1_current() -> None:
    ...
    assert _has_current_chain_marker(roadmap, _DAL_A7_1_RUNTIME_LABEL)
    ...
    assert _has_current_chain_marker(claude, _DAL_A7_1_RUNTIME_LABEL)
