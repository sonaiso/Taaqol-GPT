...
def test_close_4_and_close_5_done_with_lafzi_b0_b1_b2_done_and_b3_current() -> None:
    _declare("§8.12 CLOSE-4/CLOSE-5/DAL-A8.1/LAFZI-B0/B1/B2/B3 chain status synchronization")
    roadmap = _roadmap_text()
    claude = _claude_text()
    ...
    assert _has_done_marker(roadmap, "LAFZI-B0 Lafzi Madlul Correspondence Law"), (
        "LafziB0DoneMissing: docs/14 must mark LAFZI-B0 as ✓ done"
    )
    ...
    assert _has_done_marker(roadmap, "LAFZI-B2 WordKindCandidateGate"), (
        "LafziB2DoneMissing: docs/14 must mark LAFZI-B2 as ✓ done"
    )
    assert _has_done_marker(claude, "LAFZI-B2 WordKindCandidateGate"), (
        "LafziB2DoneMissing: CLAUDE.md must mark LAFZI-B2 as ✓ done"
    )
    assert _has_done_marker(roadmap, "LAFZI-B3 SourceIdentityGate"), (
        "LafziB3DoneMissing: docs/14 must mark LAFZI-B3 as ✓ done"
    )
    assert _has_done_marker(claude, "LAFZI-B3 SourceIdentityGate"), (
        "LafziB3DoneMissing: CLAUDE.md must mark LAFZI-B3 as ✓ done"
    )
    assert _has_done_marker(roadmap, "LAFZI-B4 FormStateGate"), (
        "LafziB4DoneMissing: docs/14 must mark LAFZI-B4 as ✓ done"
    )
    ...
    assert _has_current_marker(roadmap, "LAFZI-B7 LafziMadlulClosed -> Wad'iMadlulGate integration"), (
        "LafziB7CurrentMissing: docs/14 must mark LAFZI-B7 as → current"
    )
    assert _has_current_marker(claude, "LAFZI-B7 LafziMadlulClosed -> Wad'iMadlulGate integration"), (
        "LafziB7CurrentMissing: CLAUDE.md must mark LAFZI-B7 as → current"
    )
