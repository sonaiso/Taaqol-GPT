...
_ALLOWED_WEIGHT_FIRST_PARTY = {
    ...
    "taaqqul_slot_geometry.weight.dal_only",
    "taaqqul_slot_geometry.weight.dalalah_candidates",
    "taaqqul_slot_geometry.weight.formal_shape",
    "taaqqul_slot_geometry.weight.formal_shape_built_reference",
    "taaqqul_slot_geometry.weight.formal_shape_composition",
    "taaqqul_slot_geometry.weight.formal_shape_contract_slot",
    ...
    "taaqqul_slot_geometry.weight.mafhum_closure",
...
def test_weight_package_exports_exactly_the_reserved_carrier_surface() -> None:
    ...
    assert set(module.__all__) == {
        ...
        "HukmState",
        "HukmVerdict",
        # PR-21M: ManāṭCandidate exports (docs/44)
        "MANAT_RANK_CEILING",
        "ManatCandidate",
        "ManatMode",
        "ManatState",
        ...
        # PR-22: TanzilCandidate exports (docs/45)
        "TANZIL_RANK_CEILING",
        "TanzilCandidate",
        ...
        # PV-A4: MafhumClosure exports (docs/50)
        "MAFHUM_RANK_CEILING",
        "MafhumBranchType",
