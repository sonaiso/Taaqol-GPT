...
- `117_Z0_M2C_MCE_CLOSURE_EVIDENCE.md`: dedicated Z0-M2 closure-evidence record (`Z0-M2C`) binding remap-ledger MCE triangle fields (`backward_proof`, `forward_readiness`, `triangle_coherence`) to explicit proofs without runtime mutation.
