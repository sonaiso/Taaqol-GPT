...
- `99_CONSTITUTIONAL_LEXICON_LICENSING_ARCHITECTURE_LAW.md`: law-only lexical licensing architecture boundary (`LEXICON-L1`) defining layered source/reading/identity/path/evidence/rank/residual discipline and bounding `ContractableUnit -> LexicalMadlulCandidate` without semantic/hukm/truth runtime opening.
