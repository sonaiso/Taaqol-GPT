...
class USMFailureCode(StrEnum):
    ...
    REVOKED_EVIDENCE_UNRESOLVED = "REVOKED_EVIDENCE_UNRESOLVED"
    REVOCATION_DEPENDENCY_REFERENCE_UNRESOLVED = "REVOCATION_DEPENDENCY_REFERENCE_UNRESOLVED"
    REVOCATION_NO_REMAINING_LICENSED_DERIVATION = "REVOCATION_NO_REMAINING_LICENSED_DERIVATION"
    REVOCATION_NO_RETROACTIVE_RESCUE = "REVOCATION_NO_RETROACTIVE_RESCUE"
