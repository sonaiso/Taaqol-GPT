...
class FailureCode(StrEnum):
    ...
    UPSTREAM_MUFRAD_DALALAH_MISSING = "UPSTREAM_MUFRAD_DALALAH_MISSING"

    # --- Mafhūm closure failures (docs/50 §6 — PV-A4) ----------------------------
    NO_MAFHUM_BEFORE_MANTUQ_CLOSURE = "NO_MAFHUM_BEFORE_MANTUQ_CLOSURE"
    NO_MAFHUM_WITHOUT_OUTSIDE_BOUNDARY = "NO_MAFHUM_WITHOUT_OUTSIDE_BOUNDARY"
    NO_MAFHUM_WITHOUT_SOURCE_DOMAIN = "NO_MAFHUM_WITHOUT_SOURCE_DOMAIN"
    NO_MAFHUM_WITHOUT_BRANCH_RELATION = "NO_MAFHUM_WITHOUT_BRANCH_RELATION"
    NO_MAFHUM_CROSS_DOMAIN_LEAP = "NO_MAFHUM_CROSS_DOMAIN_LEAP"
    MANTUQ_BLOCKS_MAFHUM = "MANTUQ_BLOCKS_MAFHUM"
    MAFHUM_HIDDEN_RESIDUAL = "MAFHUM_HIDDEN_RESIDUAL"
    MAFHUM_HUKM_LEAP = "MAFHUM_HUKM_LEAP"
    MAFHUM_TANZIL_LEAP = "MAFHUM_TANZIL_LEAP"
