"""Physics realization over the frozen GUA general core."""
...
def build_physics_realization(core_freeze: CoreFreeze, trace_ref: str) -> RealizationContract:
    """Build the physics realization contract from a frozen general core."""

    slot = TypedSlot(
        slot_type="unit",
        domain_id="physics",
        coordinates=("signal", "frame"),
    ...
    transition = TransitionContract(
        transition_id="physics_unit_to_relation",
