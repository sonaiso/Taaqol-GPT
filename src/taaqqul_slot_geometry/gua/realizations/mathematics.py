"""Mathematics realization over the frozen GUA general core."""
...
def build_mathematics_realization(core_freeze: CoreFreeze, trace_ref: str) -> RealizationContract:
    """Build the mathematics realization contract from a frozen general core."""

    slot = TypedSlot(
        slot_type="unit",
        domain_id="mathematics",
        coordinates=("symbol", "order"),
    ...
    transition = TransitionContract(
        transition_id="mathematics_unit_to_relation",
